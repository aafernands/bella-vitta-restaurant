...
export default function Contact() {
  ...
  const metadata = {
    ...
    description: 'Get in touch with us. Fill out the form or contact us directly via phone or email.',
    openGraph: {
      title: 'Contact Us - Your Website Name',
      description: 'Contact us for inquiries, support, or feedback. We are here to help!',
      url: 'https://www.yourwebsite.com/contact',  // Replace with your actual URL
      images: [
        {
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="contact, support, inquiries, contact us" />
